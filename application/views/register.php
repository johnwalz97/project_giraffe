<?php
$this->load->view('partials/head_signin', ['title' => 'Register']);
				...
				<form id="signupform" class="form-horizontal" role="form" action="/welcome/register" method="post">
					...
					<div class="form-group">
						...
						<div class="col-md-offset-3 col-md-9">
							<input id="btn-signup" type="submit" class="btn btn-primary" value="Sign Up">
						</div>
					</div>
				</form>
			</div>
		</div>
		<p><a href="/welcome/signin_page" style="color: white">Already have an account? Login!</a></p>
	</div>
</div>